...
#define EASYBUTTON_INTERRUPT 0
#define EASYBUTTON_POLL 1
...
public:
	...
	bool read(int read_type = EASYBUTTON_POLL);											// Returns the current debounced button state, true for pressed, false for released.
